        ...
        <div className="grid grid-cols-4 p-20 gap-16">
          {mahasiswa.map((mahasiswa) => (
            <div
              ...
              className={`bg-[#FBF9F1] h-[36rem] flex flex-col justify-center items-center cursor-pointer hover:scale-110 hover:shadow-lg z-10 hover:z-30 transition duration-300 ease-in-out`}>
