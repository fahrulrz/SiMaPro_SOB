  ...
  const handleDelete = async (id: number) => {
    ...
    try {
      ...
      if (res.status === 200) {
        ...
        setConfirmDelete(false);
        Swal.fire({
          title: "Delete Stakeholder Success!",
          icon: "success",
            ...
            <div>
              <div className="w-fit mt-10 text-xl max-sm:text-base max-sm:w-full flex flex-col text-primary">
                <div className="grid grid-cols-12">
                  ...
                  <div className="col-span-8">{stakeholder?.nama}</div>
                </div>
                <div className="grid grid-cols-12">
                  <div className="col-span-3">Kategori</div>
                  <div className="flex items-center justify-center">:</div>
                  <div className="col-span-8">{stakeholder?.kategori}</div>
                </div>
                <div className="grid grid-cols-12">
                  <div className="col-span-3">Email</div>
                  <div className="flex items-center justify-center">:</div>
                  <div className="col-span-8">{stakeholder?.email}</div>
                </div>
                <div className="grid grid-cols-12">
                  <div className="col-span-3">Nomor Telepon</div>
                  <div className="flex justify-center">:</div>
                  <div className="col-span-8 ">
                    {stakeholder?.nomor_telepon}
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="gap-4 mt-10 w-full grid grid-cols-2 px-24 max-sm:px-8">
                <div>
                  <Link href={`/stakeholder/edit-stakeholder?id=${id}`}>
                    <button className="bg-primary flex w-full text-lg max-sm:text-sm hover:bg-white hover:text-primary items-center gap-3 p-2 max-sm:px-2 text-center max-sm:py-3 px-6 text-white rounded-md">
                      {" "}
                ...
                <div>
                  <div
                    ...
                    className="bg-primary w-full flex cursor-pointer text-lg max-sm:text-sm max-sm:px-2 hover:bg-white hover:text-primary items-center text-center gap-3 p-2 px-6 max-sm:py-3 text-white rounded-md"
                  >
